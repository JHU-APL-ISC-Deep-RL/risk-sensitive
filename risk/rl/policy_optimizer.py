...
from risk.common.utils import get_env_object, get_network_object, get_sampler
...
class PolicyOptimizer(object):
    ...
    def run_trajectory(self, random_seed=None, env=None):
        ...
        while True:
            ...
            episode_buffer = self.update_episode_buffer(episode_buffer, action, reward, policy, log_prob, value, done)
            self.obs = output_obs
            if done:
